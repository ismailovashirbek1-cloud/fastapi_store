...
class UserProfile(Base):
    ...
    def __repr__(self):
        return f'{self.first_name}, {self.last_name}, {self.username}, {self.email}, {self.phone_number}'
...
class Category(Base):
    ...
    def __repr__(self):
        return f'{self.category_image}, {self.category_name}'
...
class Product(Base):
    ...
    def __repr__(self):
        return f'{self.product_name}, {self.description}, {self.video}'
